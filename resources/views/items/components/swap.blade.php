<form class="row g-1" action="{{ route('items.swap') }}" method="POST" class="flex items-center gap-2">
    @csrf
    ...
    <div class="col-auto">
        <button class="icon" type="submit" data-tooltip="Поменяться">
            @component('elements.icon', ['size' => 21, 'name' => 'sorting-arrows-horizontal', 'color' => 'BAC7E3'])
            @endcomponent
        </button>
    </div>
</form>
